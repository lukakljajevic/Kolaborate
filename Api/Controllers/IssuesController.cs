...
namespace Api.Controllers
{
    ...
    public class IssuesController : ControllerBase
    {
        ...
        // POST /api/issues/:id/attachment
        [HttpPost("{issueId}/attachment"), DisableRequestSizeLimit]
        public async Task<IActionResult> UploadAttachment([FromRoute] string issueId, [FromForm] AddAttachmentDto dto)
        {
            var userId = User.GetUserId();
            ...
            if (dto.Attachment != null && dto.Attachment.Length > 0)
            {
                ...
                var folderName = Path.Combine("Resources", "Attachments", issueId);
